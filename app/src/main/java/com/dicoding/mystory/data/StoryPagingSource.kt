...
class StoryPagingSource(private val apiService: ApiServiceDB) : PagingSource<Int, StoryResponseDB>() {
    private companion object {
        const val INITIAL_PAGE_INDEX = 1
    }

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int,StoryResponseDB> {
        return try {
    ...
    override fun getRefreshKey(state: PagingState<Int, StoryResponseDB>): Int? {
